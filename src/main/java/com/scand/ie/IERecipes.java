...
public class IERecipes {
    ...
    public static void initCraftingRecipes(IAdvancedCraftingManager manager) {
        ...
        manager.addShapedRecipe(rl("adva_solar_reactor_cooling_component"),
                ...
                "ABA", "BCB", "ABA",
                'A', ModItems.SOLAR_COOLER_BASIC.get(),
                'B', ModItems.HYDROGEN_CELL.get(),
                'C', IC2Items.OVERCLOCKER_UPGRADE);
        manager.addShapedRecipe(rl("basic_solar_reactor_cooling_component"),
                ModItems.SOLAR_COOLER_BASIC.get().getDefaultInstance(),
                "ABA", "BCB", "ABA",
                'A', ModItems.SOLAR_COMPONENT_BASIC_DAY.get(),
                'B', IC2Items.CELL_WATER,
                'C', IC2Items.UPGRADE_BASE);
        manager.addShapedRecipe(rl("overclocked_solar_reactor_cooling_component"),
                ModItems.SOLAR_COOLER_OVERCLOCKED.get().getDefaultInstance(),
                "ABA", "BCB", "ABA",
                'A', ModItems.SOLAR_COOLER_ADVANCED.get(),
                'B', ModItems.HELIUM_CELL.get(),
                'C', IC2Items.QUANTUM_OVERCLOCKER_UPGRADE);
        manager.addShapedRecipe(rl("solar_preventer"),
                ModItems.SOLAR_PREVENTER.get().getDefaultInstance(),
                "ABA", "BCB", "ABA",
                'A', ModItems.SOLAR_COOLER_OVERCLOCKED.get(),
                'B', IC2Items.PLATING_CONTAINMENT,
                'C', IC2Items.ENERGY_STORAGE_UPGRADE);
        ...
        //Solar Reactor Components
        //  Advanced
        manager.addShapedRecipe(rl("advanced_day"),
                ModItems.SOLAR_COMPONENT_ADVANCED_DAY.get().getDefaultInstance(),
                " A ", "ABA", " A ",
                'B', ModItems.SOLAR_COMPONENT_BASIC_DAY.get(),
                'A', ModItems.SILICON.get());

        manager.addShapedRecipe(rl("advanced_night"),
                ModItems.SOLAR_COMPONENT_ADVANCED_NIGHT.get().getDefaultInstance(),
                " A ", "CBC", " A ",
                'B', ModItems.SOLAR_COMPONENT_BASIC_DAY.get(),
                'A', ModItems.SILICON.get(),
                'C', ModItems.MOON_MATTER.get());

        //  Basic
        manager.addShapedRecipe(rl("basic_day"),
                ModItems.SOLAR_COMPONENT_BASIC_DAY.get().getDefaultInstance(),
                " A ", "ABA", " A ",
                'B', IC2Items.CELL_ELECTROLYZED_WATER,
                'A', ModItems.SILICON.get());

        manager.addShapedRecipe(rl("basic_night"),
                ModItems.SOLAR_COMPONENT_BASIC_NIGHT.get().getDefaultInstance(),
                " A ", "CBC", " A ",
                'B', IC2Items.CELL_ELECTROLYZED_WATER,
                'A', ModItems.SILICON.get(),
                'C', ModItems.MOON_MATTER.get());
        ...
        //  Overclocked
        manager.addShapedRecipe(rl("overclocked_day"),
                ModItems.SOLAR_COMPONENT_OVERCLOCKED_DAY.get().getDefaultInstance(),
                "DAD", "ABA", "DAD",
                'B', ModItems.SOLAR_COMPONENT_ADVANCED_DAY.get(),
                'A', ModItems.SILICON.get(),
                'D', IC2Items.QUANTUM_OVERCLOCKER_UPGRADE);

        manager.addShapedRecipe(rl("overclocked_night"),
                ModItems.SOLAR_COMPONENT_OVERCLOCKED_NIGHT.get().getDefaultInstance(),
                "DAD", "CBC", "DAD",
                'B', ModItems.SOLAR_COMPONENT_ADVANCED_NIGHT.get(),
                'A', ModItems.SILICON.get(),
                'C', ModItems.MOON_MATTER.get(),
                'D', IC2Items.QUANTUM_OVERCLOCKER_UPGRADE);

        //Reactor Thermoelements
        manager.addShapedRecipe(rl("helium_thermoelement"),
                new ItemStack(ModBlocks.HELIUM_THERMOELEMENT.get()),
                "ABA", "BCB", "ABA",
                'B', IC2Blocks.TIN_BLOCK,
                'A', ModItems.HELIUM_CELL.get(),
                'C', IC2Blocks.VALVE);
        manager.addShapedRecipe(rl("aluminium_thermoelement"),
                new ItemStack(ModBlocks.ALUMINIUM_THERMOELEMENT.get()),
                "ABA", "BCB", "ABA",
                'B', IC2Blocks.ALUMINIUM_BLOCK,
                'A', ModItems.HYDROGEN_CELL.get(),
                'C', IC2Blocks.VALVE);
        manager.addShapedRecipe(rl("silver_thermoelement"),
                new ItemStack(ModBlocks.SILVER_THERMOELEMENT.get()),
                "ABA", "BCB", "ABA",
                'B', IC2Blocks.SILVER_BLOCK,
        ...
        //Reactor crafts
        manager.addShapedRecipe(rl("hydrogen_reactor"),
                new ItemStack(ModBlocks.HYDROGEN_REACTOR.get()),
                "ABA", "BCB", "ABA",
                'B', IC2Blocks.STEAM_REACTOR_CHAMBER,
                'A', IC2Items.PLATE_IRIDIUM,
                'C', IC2Blocks.STEAM_REACTOR);

        manager.addShapedRecipe(rl("helium_reactor"),
                new ItemStack(ModBlocks.HELIUM_REACTOR.get()),
                "ABA", "BCB", "ABA",
                'B', ModBlocks.ALUMINIUM_THERMOELEMENT.get(),
                'A', ModItems.HYDROGEN_CELL.get(),
                'C', ModBlocks.HYDROGEN_REACTOR.get());

       manager.addShapedRecipe(rl("solar_reactor"),
        ...
        manager.addShapedRecipe(rl("quantum_quarry"),
                ...
                '#', IC2Blocks.MINER,
                'D', IC2Items.DRILL_ADVANCED);

        manager.addShapedRecipe(rl("advanced_quantum_quarry"),
                new ItemStack(ModBlocks.ADVANCED_QUANTUM_QUARRY.get()),
                "CPC", "M#M", "ADA",
                'C', ModBlocks.IRIDIUM_CABLE.get(),
                'P', ModItems.UTEC.get(),
                'A', ModItems.HIGHLY_ADVANCED_ALLOY.get(),
                'M', ModBlocks.QUANTUM_MACHINE_CASING.get(),
                '#', ModBlocks.QUANTUM_QUARRY.get(),
                'D', IC2Items.UPGRADE_CONTAINER);
    ...
    public static void initMachineRecipes() {
        ...
        IC2.RECIPES.get(true).macerator.registerListener(r -> {
            ...
            r.addSimpleRecipe(rl("singularity_shard"), new ItemStack(ModItems.SINGULARITY_SHARD.get()), new ItemStack(ModItems.DARK_MATTER.get(), 4));
        });
