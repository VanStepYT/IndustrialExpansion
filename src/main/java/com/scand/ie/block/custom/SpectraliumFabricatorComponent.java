...
public class SpectraliumFabricatorComponent extends GuiWidget {

    SpectraliumFabricatorTile tile;

    public SpectraliumFabricatorComponent(SpectraliumFabricatorTile tile) {
