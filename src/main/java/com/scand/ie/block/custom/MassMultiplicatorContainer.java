...
public class MassMultiplicatorContainer extends ContainerComponent<MassMultiplicator> {

    public MassMultiplicatorContainer(MassMultiplicator key, Player player, int id) {
        super(key, player, id);
        this.addSlot(FilterSlot.createOutputSlot(key, 0, 80, 34));
        this.addPlayerInventory(player.getInventory());
        this.addComponent(new MassMultiplicatorComponent(key));
    }
