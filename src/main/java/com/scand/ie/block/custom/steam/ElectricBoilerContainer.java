...
import ic2.core.block.machines.containers.lv.BaseMultiMachineContainer;
...
public class ElectricBoilerContainer extends ContainerComponent<ElectricBoilerTile> {
    public static final ResourceLocation TEXTURE = new ResourceLocation("ie", "textures/gui/electric_boiler.png");
    ...
    public ElectricBoilerContainer(ElectricBoilerTile key, Player player, int id) {
        super(key, player, id);
